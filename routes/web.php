...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::post('/chusqers/{chusqer}', 'ChusqersController@like')->name('chusqers.like');
    Route::post('/chusqers/dislike/{chusqer}', 'ChusqersController@dislike')->name('chusqers.dislike');
